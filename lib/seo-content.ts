...
export const faqVariations = [
  ...
  },
  {
    ...
    a: "Absolutely! VidGro is YouTube TOS compliant. We provide real engagement from real creators, which actually helps the YouTube algorithm discover your content. No fake views or bots that could harm your channel."
  },
  {
...
export const ctaVariations = {
  primary: [
    ...
    "Claim Your Welcome Coins",
    "Start Earning Coins Now",
    "Get Real Views Today",
...
export const socialProofStats = {
  activeCreators: { min: 48000, max: 52000, suffix: "+" },
  coinsEarned: { min: 2400000, max: 2600000, suffix: "M+" },
  videosPromoted: { min: 480000, max: 520000, suffix: "K+" },
